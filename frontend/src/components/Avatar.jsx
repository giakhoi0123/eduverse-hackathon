function Avatar({ character, size = 'md' }) {
  ...
  return (
    <div
      className={`${sizeClasses[size]} rounded-full bg-gradient-to-br ${getColorClass(character.color)} flex items-center justify-center text-white font-bold flex-shrink-0`}
    >
